...
#Running Target Encoding
#total = len(cats)
#i=0
#for var in enumerate(cats):
#    tr_enc, ts_enc = target_encoder(pandas_train, pandas_test, var, 'SalePrice')
#    #v_enc, ts_enc = target_encoder(valid, valid, var, 'SalePrice')
#    i = i+1
#    print('Encoding: ' + var + ' (' + str(i) + '/' + str(total) + ') ...')
#
